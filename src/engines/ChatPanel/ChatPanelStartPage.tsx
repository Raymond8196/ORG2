...
function StartPageActionCard({
  ...
  return (
    <button
      type="button"
      className={`group flex w-full items-center gap-2 rounded-full border p-2 text-left shadow-sm transition-colors focus-visible:border-primary-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-6/20 ${START_PAGE_ACTION_TONE_CLASS[action.tone]}`}
