...
pub static PROVIDERS: &[ProviderSpec] = &[
    ...
    ProviderSpec {
        ...
        default_anthropic_api_base: Some("https://open.bigmodel.cn/api/anthropic"),
        is_local: false,
    ...
    ProviderSpec {
        ...
        default_anthropic_api_base: Some("https://api.moonshot.cn/anthropic"),
        is_local: false,
    ...
    ProviderSpec {
        ...
        default_anthropic_api_base: Some("https://api.siliconflow.cn"),
        is_local: false,
