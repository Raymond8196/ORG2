...
pub(super) fn cli_agent_registry() -> Vec<CliAgentEntry> {
    vec![
        ...
        CliAgentEntry {
            ...
            has_subscription_plan: true,
            compatible_api_providers: &["openai_api", "zenmux_api", "longcat_api"],
            is_complex_setup: false,
            default_setup_method: None,
            popular: true,
        ...
        CliAgentEntry {
            ...
            has_subscription_plan: true,
            compatible_api_providers: &["zenmux_api"],
            is_complex_setup: false,
            default_setup_method: None,
            popular: false,
        ...
        CliAgentEntry {
            ...
            brand_color: "#D97706",
            docs_url: "https://github.com/punkpeye/openclaude",
            has_subscription_plan: false,
            compatible_api_providers: &["anthropic_api"],
            is_complex_setup: false,
            default_setup_method: None,
            popular: false,
        ...
        CliAgentEntry {
            ...
            has_subscription_plan: false,
            compatible_api_providers: &["openai_api", "anthropic_api", "gemini_api"],
            is_complex_setup: false,
            default_setup_method: None,
            popular: true,
            icon_provider: "aider",
        ...
        CliAgentEntry {
            ...
            has_subscription_plan: true,
            compatible_api_providers: &["anthropic_api", "openai_api"],
            is_complex_setup: false,
            default_setup_method: None,
            popular: true,
            icon_provider: "cline",
        ...
        CliAgentEntry {
            ...
            brand_color: "#1E293B",
            docs_url: "https://github.com/commandcode-ai/command-code",
            has_subscription_plan: false,
            compatible_api_providers: &["openai_api", "anthropic_api"],
            is_complex_setup: false,
            default_setup_method: None,
        ...
        CliAgentEntry {
            ...
            has_subscription_plan: false,
            compatible_api_providers: &["dashscope_api"],
            is_complex_setup: false,
            default_setup_method: None,
            popular: false,
        ...
        CliAgentEntry {
            ...
            brand_color: "#10B981",
            docs_url: "https://github.com/droid-ai/droid",
            has_subscription_plan: false,
            compatible_api_providers: &["openai_api", "anthropic_api"],
            is_complex_setup: false,
            default_setup_method: None,
        ...
        CliAgentEntry {
            ...
            brand_color: "#F59E0B",
            docs_url: "https://github.com/ante-dev/ante",
            has_subscription_plan: false,
            compatible_api_providers: &["openai_api", "anthropic_api"],
            is_complex_setup: false,
            default_setup_method: None,
        ...
        CliAgentEntry {
            ...
            brand_color: "#8B5CF6",
            docs_url: "https://github.com/autohand-ai/autohand",
            has_subscription_plan: false,
            compatible_api_providers: &["openai_api", "anthropic_api"],
            is_complex_setup: false,
            default_setup_method: None,
        ...
        CliAgentEntry {
            ...
            brand_color: "#0F766E",
            docs_url: "https://github.com/omp-ai/omp",
            has_subscription_plan: false,
            compatible_api_providers: &["openai_api", "anthropic_api"],
            is_complex_setup: false,
            default_setup_method: None,
        ...
        CliAgentEntry {
            ...
            brand_color: "#7C3AED",
            docs_url: "https://github.com/pi-ai/pi",
            has_subscription_plan: false,
            compatible_api_providers: &["openai_api", "anthropic_api"],
            is_complex_setup: false,
            default_setup_method: None,
...
pub(super) fn cli_env_config(name: &str) -> Option<AgentEnvConfig> {
    ...
    match name {
        ...
        "crush" => Some(cfg(
            ...
            Some("ANTHROPIC_BASE_URL"),
            true,
            "codeAccounts.apiKeyPlaceholder.crush",
            Some("https://api.example.com"),
        )),
        "codebuff" => Some(cfg(
            "CODEBUFF_API_KEY",
        ...
        "command_code" => Some(cfg(
            "COMMAND_CODE_API_KEY",
            None,
            false,
            "codeAccounts.apiKeyPlaceholder.command_code",
            None,
        )),
        "mimo_code" => Some(cfg(
            "ANTHROPIC_API_KEY",
