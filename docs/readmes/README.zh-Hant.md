...
- [Windows x64 安裝程式](https://github.com/yorgai/ORG2/releases/latest/download/ORG2-latest-windows-x64-setup.exe)
...
- [最新版本的所有資源](https://github.com/yorgai/ORG2/releases/latest)
