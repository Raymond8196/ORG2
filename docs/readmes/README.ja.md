...
- [Windows x64 インストーラー](https://github.com/yorgai/ORG2/releases/latest/download/ORG2-latest-windows-x64-setup.exe)
...
- [最新リリースのすべてのアセット](https://github.com/yorgai/ORG2/releases/latest)
