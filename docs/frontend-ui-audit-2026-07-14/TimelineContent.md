...
|  172 | Action summary                         | keep with reason | All seven canonical resource actions are translated in every shipped locale. Stable read/write count attributes let rendered E2E assert the semantic facts without depending on localized text.                             | None.            |
