...
| `NavigationSidebar.tsx` reveal effect  | `scrollIntoView({ block: "nearest" })`                   | keep with reason | It makes the selected historical row visible without moving keyboard focus or forcing a large centered scroll.                                                                    | —                |

## D5 — Visual Patterns Observed

| Pattern                                  | Verdict          | Reason                                                                                                                                                                                                                            |
| ---------------------------------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cross-surface “reveal menu row” behavior | keep with reason | The generic sidebar owns scoped scrolling; the workstation connector owns filters, section collapse, and subagent expansion. This avoids embedding workstation rules in Session Blame or duplicating scroll logic at each caller. |
